...
<div class="wrapper">
    ...
    <form method="POST" style="margin-bottom: 20px;">
        <div style="display: flex; flex-direction: column; gap: 10px; width: 300px;">
            <input name="blog_name" value="<?= htmlspecialchars($blog_name); ?>" type="text" placeholder="Search by Blog Title" style="padding: 5px;">
            <input name="author_name" value="<?= htmlspecialchars($author_name); ?>" type="text" placeholder="Search by Author Name" style="padding: 5px;">
